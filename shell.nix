...
in pkgs.mkShell {
  ...
  shellHook = "alias query='clojure -X inferenceql.auto-modeling.query-server/run :lang :permissive'; export PYTHONPATH=${pythonWithPackages}/${pythonWithPackages.sitePackages}";
}
