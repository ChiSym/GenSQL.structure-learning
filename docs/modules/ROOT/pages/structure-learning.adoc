...
This guide will help you use the IQL structure-learning project to build your own
...
sections go into more detail about different backends for structure-learning and a number of other considerations.
...
[source,bash]
----
git clone git@github.com:OpenIQL/inferenceql.structure-learning.git InferenceQL
----
