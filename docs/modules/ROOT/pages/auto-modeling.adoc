...
https://github.com/InferenceQL/inferenceql.auto-modeling/blob/main/.dvc/config[.dvc/config file].

Users need to change the s3 bucket and sub-address in https://github.com/InferenceQL/inferenceql.auto-modeling/blob/main/.dvc/config#L5[this line]
...
Bugs can be reported via our https://github.com/InferenceQL/inferenceql.auto-modeling/issues[issue tracker].
...
- Setting the https://github.com/InferenceQL/inferenceql.auto-modeling/blob/main/params.yaml#L3[sample_count] to 1.
- Set https://github.com/InferenceQL/inferenceql.auto-modeling/blob/main/params.yaml#L30[Loom inference steps] to 1.
- Set https://github.com/InferenceQL/inferenceql.auto-modeling/blob/main/params.yaml#L32-L33[Python inference steps] to 1.
- Sub-sample maximally 1000 rows by setting https://github.com/InferenceQL/inferenceql.auto-modeling/blob/main/params.yaml#L11[N here]
